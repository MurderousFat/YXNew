...
@Controller("BiRegionAction")
@Scope(value="prototype")
public class BiRegionAction extends BaseAction {
    
    @Autowired
    private BiRegionService biRegionService;
    ...
    public String list() throws IOException{
        ...
        List<BiRegionDto> list = biRegionService.listBy(this.getRequestDto());
    ...
    private String save() throws IOException{
        ...
        BiRegionDto biRegionDto = new BiRegionDto();
