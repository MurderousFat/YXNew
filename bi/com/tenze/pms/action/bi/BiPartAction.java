...
@Controller("BiPartAction")
@Scope(value="prototype")
public class BiPartAction extends BaseAction {
    
    @Autowired
    private BiPartService biPartService;
    

    public String listPage() throws IOException{
        
        PageBean pageBean = biPartService.listPage(this.getPageParam(),this.getRequestDto());
    ...
    public String list() throws IOException{
        ...
        List<BiPartDto> list = biPartService.listBy(this.getRequestDto());
    ...
    private String save() throws IOException{
        ...
        BiPartDto biPartDto = new BiPartDto();
        DataObjectUtils.mapToObject(biPartDto, this.getRequestDto());
        try{
            long result = biPartService.save(biPartDto);
            if(result<1){
    ...
    public String remove() throws IOException{
        ...
        try{
            biPartService.deleteByIds(TenzeUtils.str2IdList(key));
                setSuccessTipMsg();
                return NULL_SUCCESS;
        }catch(Exception e){
            e.printStackTrace();
