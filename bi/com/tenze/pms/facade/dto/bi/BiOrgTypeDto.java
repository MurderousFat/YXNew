 ...
 *
 */
public class BiOrgTypeDto extends BaseEntity{
...
public BiOrgTypeDto(Long id){this.id=id;}

public BiOrgTypeDto(Long id, Integer version, Date createtime, Date updatetime, Integer fdelFlag, String typeNo, String typeName){
         this.id = id;
