...
Ext.define('${base}.resources.commonjs.upload',{
	extend:'Ext.Window',
	title: '文件上传',
	width: 400,
	modal:true,
	...
	constructor: function() {
		...
		function uploadFile(){
			submitForm('${base}/upimg.tz', upload_file_form, function(form, action){
...
function _uploadImageOnlineWin(){
	...
	art.dialog.open('${base}/resources/scannerUpload/dialog.html',{
		title:'在线拍照',
