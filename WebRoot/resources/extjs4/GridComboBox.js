		...
		.define(
				'Ext.form.field.GridComboBox',
				{
					...
					initComponent : function() {
						...
						me.callParent();
						me.doQueryTask = Ext.create('Ext.util.DelayedTask',
								me.doRawQuery, me);
						...
						if (transformSelect) {
							me.render(transformSelect.parentNode,
									transformSelect);
					...
					doQuery : function(queryString, forceAll) {
						...
						if (me.fireEvent('beforequery', qe) === false
								|| qe.cancel) {
							return false;
						}
					...
					onKeyUp : function(e, t) {
						...
						if (!me.readOnly && !me.disabled && me.editable) {
							...
							// delete
							if (!e.isSpecialKey() || key == e.BACKSPACE
									|| key == e.DELETE) {
								if (me.getRawValue() == '') {
									me.clearValue();
									return;
					...
					onItemClick : function(picker, record) {
						...
						if (!me.multiSelect && lastSelection) {
							...
							if (record.get(valueField) === selected
									.get(valueField)) {
								me.collapse();
							}
						}
					...
					onExpand : function() {
						...
						var selectOnTab = me.selectOnTab, picker = me
								.getPicker();
					...
					setSubmitValue : function(keys, sp, ds) {
						...
						if (keys) {
							Ext.Array.each(keys.split(sp), function(a) {
								var r = me.store.findRecord(me.valueField, a,
										0, false, true, true);
								if (r)
									v[a] = r.data;
							});
