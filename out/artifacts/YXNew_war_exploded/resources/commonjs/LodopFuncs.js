function getLodop(oOBJECT, oEMBED) {
	 ...
	 **************************************************************************/
	var strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/resources/install_lodop32.rar' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	var strHtmUpdate = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/resources/install_lodop32.rar' target='_self'>执行升级</a>,升级后请重新进入。</font>";
	var strHtm64_Install = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/resources/install_lodop64.rar' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	var strHtm64_Update = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/resources/install_lodop64.rar' target='_self'>执行升级</a>,升级后请重新进入。</font>";
	...
	try {
		...
		// =====如下空白位置适合调用统一功能:=====
		LODOP.SET_LICENSES("惠州市格讯科技有限公司", "235CE1779D3B7F7EB73CD2F896DAD912",
				"", "");
		// =======================================
		return LODOP;
	} catch (err) {
