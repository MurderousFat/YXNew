...
import com.tenze.utils.helper.TypeCaseHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	private static final long serialVersionUID = 7328075453973645318L;
	 ...
	 * @return Date 键值
	 */
	public Date getAsDateTime2(String key) {
	...
	public Date getAsDateStart(String key) {
		Object obj = get(key);
		if (obj==null) {
			return null;
		}
		try {
			return TypeCaseHelper.convert2DateStart(obj.toString());
		} catch (Exception e) {
			return null;
		}
	...
	public Date getAsDateEnd(String key) {
		Object obj = get(key);
		if (obj==null) {
			return null;
		}
		try {
			return TypeCaseHelper.convert2DateEnd(obj.toString());
		} catch (Exception e) {
			return null;
		}
