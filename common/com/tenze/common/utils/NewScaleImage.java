...
public class NewScaleImage {
	...
	public NewScaleImage(File file, File destFile) throws IOException {
		srcFileName = file.getAbsolutePath();
		srcBufferImage = javax.imageio.ImageIO.read(file);
	...
	public void resize(int w, int h) throws IOException {
		...
		srcBufferImage = javax.imageio.ImageIO.read(srcFile);
		width = srcBufferImage.getWidth();
		height = srcBufferImage.getHeight();
