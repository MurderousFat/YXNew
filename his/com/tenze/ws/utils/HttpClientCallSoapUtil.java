...
public class HttpClientCallSoapUtil {  
     ...
     * @return 
     */  
    public static String doHttp(String getUrl) {  
        String retStr = "";  
        // 创建HttpClientBuilder  
        HttpClientBuilder httpClientBuilder = HttpClientBuilder.create();  
        // HttpClient  
    ...
    public static void main(String[] args) {  
        ...
        String querySoapXml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.cm.com\"> "
+"   <soapenv:Header/>              "
+"   <soapenv:Body>                 "
+"      <ser:getAllUserInfo>        "
+"         <!--Optional:-->         "
+"         <ser:name>ee</ser:name>  "
+"      </ser:getAllUserInfo>       "
+"   </soapenv:Body>                "
+"</soapenv:Envelope>             ";
        //采用SOAP1.1调用服务端，这种方式能调用服务端为soap1.1和soap1.2的服务  
        doPostSoap1_1("http://localhost:8080/webServe/services/UserService.UserServiceHttpSoap11Endpoint/", querySoapXml, "");  
