...
@Controller("HisSettleAction")
@Scope(value="prototype")
public class HisSettleAction extends BaseAction {
    ...
    public String listPage() throws IOException{
        ...
        PageBean pageBean = hisSettleService.listPage(this.getPageParam(),this.getRequestDto());
    ...
    public String list() throws IOException{
        ...
        List<HisSettleDto> list = hisSettleService.listBy(this.getRequestDto());
    ...
    private String save() throws IOException{
        ...
        HisSettleDto hisSettleDto = new HisSettleDto();
        DataObjectUtils.mapToObject(hisSettleDto, this.getRequestDto());
        try{
            long result = hisSettleService.save(hisSettleDto);
            if(result<1){
    ...
    public String remove() throws IOException{
        ...
        try{
            hisSettleService.deleteByIds(TenzeUtils.str2IdList(key));
                setSuccessTipMsg();
                return NULL_SUCCESS;
        }catch(Exception e){
            e.printStackTrace();
